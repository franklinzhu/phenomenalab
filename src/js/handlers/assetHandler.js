...
export default function Assets(
	...
	manager.onLoad = function() {
		var startAudio = new Audio(
			require('./../../../static/sounds/sound_Enter.mp3')
		);
		startAudio.play();
...
Assets.prototype.init = function() {
	...
	this.projectInfo = [
		...
		'<p>Main Titles for OFFFTLV 2017</p>The OFFF tlv 2017 opening title sequence was created for Wix Studio and is a collection of r&d simulation tests. The sequence reflects on the creation stage of a project and its making process. Phenomena Labs provided Soft Body & Cloth simulations for both opening title sequence and projection mapping in Tel Aviv Museum of art.<br><br>Projection Mapping video @ Tel Aviv Museum of Art:',
		//offf
		...
		'<p>Rone - Waves</p>Collaborated with Greg Barth, this time we had to create a morph between the 2 photo scanned mocap 3D main characters of the video clip the effect achieved by intersecting the geometry into each other and blend them procedurally in 3D.',
		//Rone

		'<p>DJ Snake - Magenta Riddim</p>Phenomena Labs provided FX Simulation of dust, smoke and water for this amazing music video by Gal Muggia and Vania Hayman for DJ Snake.', //DJ Snake
		...
		'<p>The Walk</p>Phenomena Labs provided FX Development for the claim-up sequence of "The Walk"in collaboration with Atomic Fiction Studios. <br><br>"You know the feeling when the whole world disappears and only you and what you are doing are left?" Director Robert Zemeckis & VFX Sup Kevin Blaine, described that moment they wanted to achieve with 3D Atmospherics simulation on the rooftop of Manhattans world trade center. Phenomena Labs were involved doing Lookdev on this effect at early stages. Developing a procedural volumetric shader in that generates 4 layers of 4D volumetric noise. The shader was carefully tuned to create large pockets of clouds based on fractal algorithms and Mathematical functions within the shader. <br><br>The unique render-time generative approached, allowed us to control the speed of which the clouds and atmospherics moves in each shot of the sequence, tune the amounts, speeds and light scattering throughout the 13 shots of the sequence.' +
			' The end result has really captured the peak moment of the film when Philip takes his first steps on the wire, and separates the audience from views of New York City for a few moments and brings them back into it with a whole new perspective.<br><br><br>Making of Video:' //thewalk
	];

	this.projectMakinVidURLs = [
		'https://player.vimeo.com/video/159758919', //futureofmusic
		'https://player.vimeo.com/video/280093507', //gravity
		'https://player.vimeo.com/video/159760813', //helloplaynye
		'https://player.vimeo.com/video/162052542', //jane
		'', //myth
		'https://player.vimeo.com/video/280093451', //offf
		'', //Rescue
		'', //Rone
		'https://player.vimeo.com/video/280093469', //DJ Snake
		'https://player.vimeo.com/video/166021791' //thewalk
	];
