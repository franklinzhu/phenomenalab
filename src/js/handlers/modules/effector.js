...
export default function Effector(
	...
	this.aboutAudio = new Audio(
		require('./../../../../static/sounds/sound_About.mp3')
	);
	this.contactAudio = new Audio(
		require('./../../../../static/sounds/sound_Contact.mp3')
	);
}
